...
const offer = [
  ...
  },
  {
    ...
    rating: '4.8',
    reviews: '3.8K',
    mobilePackageDesc: ['1 hours', 'Panjim '],
    oldPrice: '1500',
    booked: '40K+',
    buttonText: 'Book this activity & get 20% off',
    reportPrice: 1000,
    ...
    overviewDesc:
      'The 1-hour cruise on the Mandovi River in Goa offers an extraordinary experience, blending scenic beauty with culinary delights….',
    overview: [
    ...
    transport: [
      {
        ...
        desc: [
            ...
            'Dance Performances.',
            'Live DJ Music.',
            'Sightseeing of Panjim Famous attractions.',
            'Group Activity.',
        ],
      },
      {
  ...
  },
  {
    ...
    rating: '4.8',
    reviews: '3.8K',
    mobilePackageDesc: ['Min. 2 hours', 'Panjim '],
    oldPrice: '150000/Hr',
    booked: '20K+',
    buttonText: 'Book this activity & get 20% off',
    reportPrice: 130000,
    reportPriceWithTransport: 135000,
    currentPrice: '139999/Hr',
      ...
      sections: [
        {
          ...
          items: [
            '1 Hours Cruising on Mandovi River',
            'Dance Performances & Entertainment on Board(NA)',
          ],
        },
        {
          category: 'Meals',
          items: ['Starter', 'Buffet Dinner (Veg/Non-Veg)', 'Complimentary Dinks & Snacks(NA)'],
        },
        {
          category: 'Activities',
          items: ['Sightseeing of Panjim City'],
    ...
    features: [
      ...
      { name: "Sailing", image: "/img/images/svg/mobile-ico.svg" },
      { name: "Transport(NA)", image: "/img/images/svg/transfer-ico.svg" },
    ],
    highlights: [
      {
        highlights1:
    ...
    transport: [
      {
        ...
        isSelected: true,
        originalamt: '150000',
        discountedamt: '139999',
        kidAmt: '0',
        regularPrice: '150000',
        adultPrice: '139999',
        kidPrice: '0',
        adultReportPrice: '130000',
        kidReportPrice: '0',
        desc: [
            'Access to all decks',
            'Min 2-hour sailing',
